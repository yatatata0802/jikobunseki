...
export const BrainCircuitIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 9.75v.001M12.75 14.25v.001" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 9.75v.001M5.25 14.25v.001" />
    </svg>
);
